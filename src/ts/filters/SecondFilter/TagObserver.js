...
const FilterV1_1 = require("../../utils/FilterV1");
const TagsTemplate_1 = require("../../templates/TagsTemplate");
class TagObserver {
    ...
    updateListOfTags() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filterName)
                this.tags = yield FilterV1_1.FilterV1.handleTagFiltered(value, filterName);
        });
    }
    selectTags() {
        this.tags.forEach($tag => {
            $tag.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
                if (!$tag.getAttribute("disabled")) {
                    const tagTpl = new TagsTemplate_1.TagsTemplate($tag);
                    tagTpl.appendTag();
